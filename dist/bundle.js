...
},{"./URI":3}],5:[function(require,module,exports){
(function (global){
...
},{"./binding":7,"./config":9,"./deps-parser":10,"./directive":11,"./emitter":20,"./exp-parser":21,"./observer":24,"./text-parser":25,"./utils":27}],9:[function(require,module,exports){
var prefix = 'v',
    specialAttributes = [
        'pre',
        'ref',
...
},{"./emitter":20,"./observer":24,"./utils":27}],11:[function(require,module,exports){
var utils      = require('./utils'),
...
},{"./directives":14,"./filters":22,"./utils":27}],12:[function(require,module,exports){
...
},{"../config":9,"../transition":26}],14:[function(require,module,exports){
var utils      = require('../utils'),
    config     = require('../config'),
    transition = require('../transition')
...
},{"../config":9,"../transition":26,"../utils":27,"./html":12,"./if":13,"./model":15,"./on":16,"./repeat":17,"./style":18,"./with":19}],15:[function(require,module,exports){
var utils = require('../utils'),
...
},{"../config":9,"../observer":24,"../utils":27,"../viewmodel":28}],18:[function(require,module,exports){
var camelRE = /-([a-z])/g,
...
},{"../utils":27,"../viewmodel":28}],20:[function(require,module,exports){
function Emitter () {
    this._ctx = this
}
...
},{"./config":9,"./directives":14,"./filters":22,"./observer":24,"./transition":26,"./utils":27,"./viewmodel":28}],24:[function(require,module,exports){
/* jshint proto:true */
...
},{"./emitter":20,"./utils":27,"./viewmodel":28}],25:[function(require,module,exports){
var BINDING_RE = /{{{?([^{}]+?)}?}}/,
    TRIPLE_RE = /{{{[^{}]+}}}/
...
},{"./batcher":6,"./config":9}],27:[function(require,module,exports){
var config    = require('./config'),
    attrs     = config.attrs,
    toString  = ({}).toString,
    win       = window,
...
},{"./config":9,"./viewmodel":28}],28:[function(require,module,exports){
...
},{"./json-textarea":29,"URIjs/src/URITemplate":4,"vue":23}]},{},[30])